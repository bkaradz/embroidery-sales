...
<DropdownMenu.Root>
	...
	<DropdownMenu.Content class="rounded" side="left" align="end" sideOffset={4}>
		...
		<DropdownMenu.Item class="rounded" onclick={() => goto(`/products/view/${id}`)}>View Product</DropdownMenu.Item>
		<DropdownMenu.Item class="rounded" onclick={() => goto(`/products/edit/${id}`)}>Edit Product</DropdownMenu.Item>
    <DropdownMenu.Item class="rounded">View sales details</DropdownMenu.Item>
