...
import { getProductById, updateProduct } from '$lib/server/routes/products';
...
export const actions = {
  create: async (event) => {
    ...
    await updateProduct({ ...form.data, userId })

    return redirect('/products', { type: 'success', message: `Product has been updated` }, event);
